...
export function Profile() {
  ...
  const stats = [
    ...
    { label: "ยืนยัน",  value: bookings.filter((b) => b.status === "confirmed").length,      icon: "✅" },
    { label: "ยกเลิก",  value: bookings.filter((b) => ["expired","cancelled"].includes(b.status)).length, icon: "❌" },
  ];
